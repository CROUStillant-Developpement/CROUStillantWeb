...
const JoinTeam = async () => {
    ...
    return(
        <section id="team" className="flex flex-col gap-6 lg:gap-10 ">
            <h2 className="mt-32 lg:text-6xl lg:text-center lg:max-w-[60%] lg:mx-auto text-3xl font-bold leading-tight bg-gradient-to-r from-[#151414] via-[#151414] to-[#E40514] bg-clip-text text-transparent ">{t("title")}</h2>

...
export default function RestaurantCard({ restaurant }: RestaurantCardProps) {
  ...
  return (
    <TooltipProvider>
      <div className="group">
        <Card className=" relative overflow-hidden rounded-2xl border border-primary/5 bg-card/50 hover:bg-card hover:border-primary/20 transition-all duration-300 shadow-xs group-hover:shadow-xl group-hover:-translate-y-1">
          <div className="relative h-52 w-full overflow-hidden">
            ...
            >
              <Heart
                className={
                  isFavourite ? "text-red-500 fill-red-500" : "text-white"
                }
              />
            </Button>

...
const FooterCtaCard = async () => {
    ...
    return (
        <section>
            <div className="flex flex-col items-center justify-center w-full px-6 mx-auto py-20 rounded-[20px] border border-[rgba(255,255,255,0.70)] bg-[linear-gradient(113deg,_rgba(255,255,255,0.62)_0%,_rgba(255,255,255,0.20)_110.84%)] backdrop-blur-[21px]">
            ...
            <div className="flex flex-col justify-center items-center gap-3">
                <p className="bg-gradient-to-r from-[#e40514] to-[#9e2020] bg-clip-text text-transparent font-bold text-4xl md:text-5xl">{t("title")}</p>

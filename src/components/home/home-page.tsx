...
function BasicCard({
  ...
  return (
    <aside
      className={`${style} relative flex items-center min-h-[160px] h-full w-full overflow-hidden border-2 border-[rgba(85,85,85,0.1)] bg-[#FAFAFA] dark:bg-[#151414] dark:border-[rgba(85,85,85,0.35)] rounded-xl p-4 md:p-6`}
    >
      ...
      <section id="info" className="mt-32">
        ...
        <aside className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6 lg:mt-10">
          ...
          <BasicCard
            ...
            ctaLink="about"
            style={
              "md:bg-[rgba(218,214,214,0.15)] dark:bg-[rgba(218,214,214,0.08)]"
            }
          >
            <ForkKnifeCrossed
              height={200}

...
export default function RadarsCard({ style }: Props) {
  ...
  return (
    <section className={`${style}`}>
      <aside className=" flex flex-col w-full h-full gap-6 py-4 px-3.5 bg-[#FAFAFA] dark:bg-[rgba(218,214,214,0.08)] rounded-[8px] border-2 border-[rgba(85,85,85,0.1)] border-opacity-[7%] ">
        ...
        <aside className="overflow-hidden relative flex items-center justify-center w-full h-60 bg-[#F8E9E9] dark:bg-[rgba(70,70,70,0.40)] rounded-xl">
          <RadarsIcons
            style={{
              position: "absolute",
              top: "20px",

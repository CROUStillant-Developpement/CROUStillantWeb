  ...
  return (
    <section className={style}>
      <aside className="group flex flex-col w-full h-full gap-6 p-8 bg-secondary/30 rounded-4xl border border-border/50 transition-all hover:bg-secondary/40 hover:shadow-xl hover:shadow-primary/5">
        ...
        <aside className="overflow-hidden relative flex items-center justify-center w-full h-72 bg-background/50 backdrop-blur-xs rounded-3xl border border-primary/10">
          <RadarsIcons
            style={{
              position: "absolute",
              top: "20px",

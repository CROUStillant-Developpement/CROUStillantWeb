  ...
  return (
    <>
      ...
      <section className="md:col-span-2">
        <aside className=" flex flex-col md:flex-row w-full h-full gap-6 py-4 px-3.5 bg-[#FAFAFA] dark:bg-[rgba(218,214,214,0.08)] rounded-[8px] border-2 border-[rgba(85,85,85,0.1)] border-opacity-[7%] ">
          ...
          <section className="flex items-center justify-center w-full h-fit bg-[#F8E9E9] dark:bg-[rgba(70,70,70,0.40)] rounded-xl py-2.5 md:min-w-[350px]">

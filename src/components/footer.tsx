...
export default async function Footer() {
  ...
  return (
    <footer className="border-grey align-center flex w-full flex-col mt-24 py-10 font-medium md:px-0 relative">
      <div className="bg-[linear-gradient(180deg,_rgba(251,153,153,0.40)_0%,_rgba(242,242,242,0.40)_100%)] rotate-180 h-[30rem] -translate-y-24 w-full absolute -bottom-24 -z-10" />

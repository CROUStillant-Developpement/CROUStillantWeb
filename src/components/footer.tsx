...
export default async function Footer() {
  ...
  return (
    <footer className="border-grey align-center flex w-full flex-col mt-24 py-10 font-medium md:px-0 relative">
      <div className="bg-[linear-gradient(180deg,rgba(251,153,153,0.40)_0%,rgba(242,242,242,0.40)_100%)] dark:bg-[linear-gradient(180deg,rgba(255,68,68,0.4)_0%,rgba(21,20,20,0.4)_100%)] rotate-180 h-120 -translate-y-24 w-full absolute -bottom-24 -z-10" />

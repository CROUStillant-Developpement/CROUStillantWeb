    ...
    <section className="container">
      ...
      <aside className="pt-10">
        ...
        <div className="flex flex-col items-center gap-6 pt-12">
          <h1 className="text-4xl md:text-8xl text-center font-bold max-w-[80%] leading-none bg-gradient-to-r from-[#151414] via-[#151414] to-[#E40514] bg-clip-text text-transparent">{t("title.first")}</h1>

...
export default async function Changelog() {
  ...
  return (
    <div className="overflow-x-hidden space-y-8 px-4 mt-4 pb-20">
      <div className="relative mb-8 overflow-hidden rounded-2xl bg-linear-to-br from-primary/10 via-background to-background p-4 sm:p-10 shadow-xs border border-primary/10">
